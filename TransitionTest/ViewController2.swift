...
//        lenny_Dismiss(animateType: .SpreadFromRight)
//        lenny_OpenGestureDismiss(with: .left)
        lenny_OpenGestureDismiss(with: .left, with: .SpreadFromLeft)
//        lenny_Dismiss(duration: 2.0, animateType: .PushFromBottom)
